#!/usr/bin/env python
__doc__ = '''Set the unicodes of glyphs in a font based on an external file. Note that this will not currently remove any unicode values that already exist in unlisted glyphs
