...
cl = "psfbuildcompgc tests/input/font-psf-test/source/PsfTest-Regular.ufo -i tests/input/psfbuildcomp.txt -l local/testresults/ufo/psfbuildcompgc.log"
outfont = "local/testresults/ufo/psfbuildcompgc.ufo" # Set to None for commands which don't output a font
