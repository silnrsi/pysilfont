...
cl = "psfdeleteglyphs tests/input/ufo/test.ufo -i tests/input/ufo/psfdeleteglyphs.txt -l local/testresults/ufo/psfdeleteglyphs.log -p scrlevel=v"
...
exp_warnings = 4 # test.ufo should have some errors/warnings to test the code!
